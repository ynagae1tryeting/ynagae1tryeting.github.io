...
var perspective=require("gl-mat4/perspective"),multiply=require("gl-mat4/multiply"),lookAt=require("gl-mat4/lookAt"),invert=require("gl-mat4/invert"),rotate=require("gl-mat4/rotate"),transform=require("gl-vec3/transformMat4"),wolfJSON=require("./wolf.json"),SVG_NS="http://www.w3.org/2000/svg";function createNode(t){return document.createElementNS(SVG_NS,t)}function setAttribute(t,e,n){t.setAttributeNS(null,e,n)}module.exports=function(t){var e=t||{},n=!!e.followMouse,r=!!e.followMotion,i=!!e.slowDrift,o=!0,a=[0,0],l=.3,u=e.width||400,s=e.height||400,h=createNode("svg"),f={x:0,y:0},d=wolfJSON.positions.length,c=new Float32Array(3*d),w=new Float32Array(3*d),g=[];function v(t){var e=h.getBoundingClientRect();f.x=1-2*(t.x-e.left)/e.width,f.y=1-2*(t.y-e.top)/e.height}function m(t,e){this.svg=t,this.indices=e,this.zIndex=0}e.pxNotRatio||(u=window.innerWidth*(e.width||.25)|0,s=0|(window.innerHeight*e.height||u),"minWidth"in e&&u<e.minWidth&&(u=e.minWidth,s=e.minWidth*e.height/e.width|0)),setAttribute(h,"width",u+"px"),setAttribute(h,"height",s+"px"),document.body.appendChild(h),function(){for(var t=wolfJSON.positions,e=0,n=0;n<t.length;++n)for(var r=t[n],i=0;i<3;++i)c[e++]=r[i]}();var p=function(){for(var t=[],e=0;e<wolfJSON.chunks.length;++e)for(var n=wolfJSON.chunks[e],r="rgb("+n.color+")",i=n.faces,o=0;o<i.length;++o){var a=i[o],l=createNode("polygon");setAttribute(l,"fill",r),setAttribute(l,"stroke",r),setAttribute(l,"points","0,0, 10,0, 0,10"),h.appendChild(l),t.push(new m(l,a))}return t}(),A=function(){var t=new Float32Array(3),e=new Float32Array([0,1,0]),n=new Float32Array(16),r=new Float32Array(16),o=lookAt(new Float32Array(16),new Float32Array([0,0,400]),t,e),l=invert(new Float32Array(16),o),u=new Float32Array(16),s=new Float32Array(3),f=new Float32Array(16),d=new Float32Array([1,0,0]),c=new Float32Array([0,1,0]),w=new Float32Array([0,0,1]);return function(){var g=h.getBoundingClientRect(),v=g.width,m=g.height;if(perspective(n,Math.PI/4,v/m,100,1e3),invert(u,n),s[0]=a[0],s[1]=a[1],s[2]=1.2,transform(s,s,u),transform(s,s,l),lookAt(r,t,s,e),i){var p=Date.now()/1e3;rotate(r,r,.1+.2*Math.sin(p/3),d),rotate(r,r,.03*Math.sin(p/2)-.1,w),rotate(r,r,.5+.2*Math.sin(p/3),c)}return multiply(f,n,o),multiply(f,f,r),f}}();function y(t,e){return e.zIndex-t.zIndex}function x(){o=!1}function F(){o=!0}function N(){if(o){window.requestAnimationFrame(N);var t=1-l;h.getBoundingClientRect();a[0]=t*a[0]+l*f.x,a[1]=t*a[1]+l*f.y+.085,!function(t){for(var e=t[0],n=t[1],r=t[2],i=t[3],o=t[4],a=t[5],l=t[6],u=t[7],s=t[8],h=t[9],f=t[10],g=t[11],v=t[12],m=t[13],p=t[14],A=t[15],y=0;y<d;++y){var x=c[3*y],F=c[3*y+1],N=c[3*y+2],M=x*i+F*u+N*g+A;w[3*y]=(x*e+F*o+N*s+v)/M,w[3*y+1]=(x*n+F*a+N*h+m)/M,w[3*y+2]=(x*r+F*l+N*f+p)/M}}(A()),function(){var t,e=h.getBoundingClientRect(),n=e.width,r=e.height;for(g.length=0,t=0;t<p.length;++t){var i=p[t],o=i.indices,a=o[0],l=o[1],u=o[2],s=w[3*a],f=w[3*a+1],d=w[3*l],c=w[3*l+1],v=w[3*u];if(!((d-s)*(w[3*u+1]-f)-(c-f)*(v-s)<0)){for(var m=[],A=-1/0,x=1/0,F=i.svg,N=0;N<3;++N){var M=o[N];m.push(.5*n*(1-w[3*M])+","+.5*r*(1-w[3*M+1]));var b=w[3*M+2];A=Math.max(A,b),x=Math.min(x,b)}i.zIndex=A+.25*x;var S=m.join(" ");-1===S.indexOf("NaN")&&setAttribute(F,"points",S),g.push(i)}}for(g.sort(y),h.innerHTML="",t=0;t<g.length;++t)h.appendChild(g[t].svg)}(),x()}}return window.addEventListener("mousemove",function(t){o||F(),n&&(v({x:t.clientX,y:t.clientY}),N())}),window.addEventListener("deviceorientation",function(t){if(o||F(),r){const e=10;v({x:200+t.gamma*e,y:-300+t.beta*e}),N()}}),N(),{container:h,lookAt:v,setFollowMouse:function(t){n=t},setFollowMotion:function(t){r=t},stopAnimation:x,startAnimation:F}};

},{"./wolf.json":2,"gl-mat4/invert":6,"gl-mat4/lookAt":7,"gl-mat4/multiply":8,"gl-mat4/perspective":9,"gl-mat4/rotate":10,"gl-vec3/transformMat4":11}],4:[function(require,module,exports){
